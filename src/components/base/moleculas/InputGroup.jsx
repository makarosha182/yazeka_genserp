...
const img1 = (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_19035_24074)">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M17.4294 12.5C17.4294 15.4986 14.9986 17.9294 12 17.9294C9.0014 17.9294 6.57056 15.4986 6.57056 12.5C6.57056 9.50137 9.0014 7.07053 12 7.07053C14.9986 7.07053 17.4294 9.50137 17.4294 12.5ZM15.9294 12.5C15.9294 14.6701 14.1702 16.4294 12 16.4294C9.82983 16.4294 8.07056 14.6701 8.07056 12.5C8.07056 10.3298 9.82983 8.57053 12 8.57053C14.1702 8.57053 15.9294 10.3298 15.9294 12.5Z" fill="black"/>
        </g>
        <defs>
...
const img2 = (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_19035_24081)">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.06569 2.08655L6.93432 3.21792L15.7373 12.0209L6.93432 20.8238L8.06569 21.9552L18 12.0209L8.06569 2.08655Z" fill="white"/>
        </g>
        <defs>
